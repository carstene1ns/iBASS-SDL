...
Logic::Logic(SkyCompact *skyCompact, Screen *skyScreen, Disk *skyDisk, Text *skyText, Music *skyMusic, Mouse *skyMouse, Sound *skySound) {
...
/*	static int info=0;
	...
	{
		info=0;
		printf("s=%d %d, ", _scriptVariables[SCREEN], _scriptVariables[FIRST_ICON]);
	}
*/
...
bool Logic::fnChooser(uint32 a, uint32 b, uint32 c) {
	...
	uint16 ycood = TOP_LEFT_Y+CHOOSER_SPACING; // rolling coordinate
